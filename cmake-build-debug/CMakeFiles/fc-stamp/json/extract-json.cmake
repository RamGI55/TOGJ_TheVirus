...
#
get_filename_component(filename "E:/Programming/TOGJ_TheVirus/cmake-build-debug/_deps/json-tmp/json.tar.xz" ABSOLUTE)
get_filename_component(directory "E:/Programming/TOGJ_TheVirus/cmake-build-debug/_deps/json-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-json${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-json${i}")
